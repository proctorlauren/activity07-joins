...
```{r getting tidyverse, message=FALSE}
library(tidyverse)
...
**Response**: Denny's does not have any locations outside of the US. La Quinta's does have locations outside of the US.
...
**Response**: If it has countries, I would do somethong to look for countries that are not the United States. 
...
**Response**: There are no loactions outside of the United States.
